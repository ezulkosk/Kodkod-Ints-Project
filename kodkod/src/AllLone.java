...
/* 
  ...
  ==================================================
    (all this: this/Test | 
      one (this . this/Test.weight) && 
      (this . this/Test.weight) in ints) && 
    (this/Test.weight . univ) in this/Test && 
    (all this: this/Test | 
      lone (this . this/Test.x) && 
      (this . this/Test.x) in ints) && 
    (this/Test.x . univ) in this/Test && 
    (all this: this/Test | 
      lone (this . this/Test.y) && 
      (this . this/Test.y) in ints) && 
    (this/Test.y . univ) in this/Test && 
    (all this: this/Test | 
      (this . this/Test.weight) = Int[int[this . this/Test.x] + int[this . 
      this/Test.y]]) && 
    Int/min = Int/min && 
    Int/zero = Int/zero && 
    Int/max = Int/max && 
