...
/* 
  ...
  ==================================================
    ...
    (int[this/Test . this/Test.weight] + int[this/Test2 . this/Test2.weight]) = 
    3 && 
    Int/min = Int/min && 
    Int/zero = Int/zero && 
    Int/max = Int/max && 
  ...
  ==================================================
*/
public final class ConstraintFor2InPredicate {
...
Expression x142=x6.join(x11);
IntExpression x141=x142.sum();
Expression x144=x7.join(x15);
IntExpression x143=x144.sum();
IntExpression x140=x141.plus(x143);
IntExpression x145=IntConstant.constant(3);
Formula x139=x140.eq(x145);
Formula x146=x0.eq(x0);
Formula x147=x1.eq(x1);
Formula x148=x2.eq(x2);
Formula x149=x3.eq(x3);
Formula x150=x4.eq(x4);
Formula x151=x5.eq(x5);
Formula x152=x6.eq(x6);
Formula x153=x7.eq(x7);
Formula x154=x8.eq(x8);
Formula x155=x9.eq(x9);
Formula x156=x10.eq(x10);
Formula x157=x11.eq(x11);
Formula x158=x12.eq(x12);
Formula x159=x13.eq(x13);
Formula x160=x14.eq(x14);
Formula x161=x15.eq(x15);
Formula x16=Formula.compose(FormulaOperator.AND, x17, x25, x28, x35, x37, x44, x46, x53, x55, x79, x86, x88, x95, x97, x104, x106, x113, x115, x139, x146, x147, x148, x149, x150, x151, x152, x153, x154, x155, x156, x157, x158, x159, x160, x161);
...
Formula[] formulas = ier.reduceIntExpressions( x17, x25, x28, x35, x37, x44, x46, x53, x55, x79, x86, x88, x95, x97, x104, x106, x113, x115, x139, x146, x147, x148, x149, x150, x151, x152, x153, x154, x155, x156, x157, x158, x159, x160, x161);//x77, x78
