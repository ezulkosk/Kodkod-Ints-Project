...
/* 
  ==================================================
    kodkod formula: 
  ==================================================
    no (this/Jocelyn & this/Hilary) && 
    (all P10_this: this/Jocelyn + this/Hilary + this/Person remainder | 
      one (P10_this . this/Person.spouse) && 
      (P10_this . this/Person.spouse) in (this/Jocelyn + this/Hilary + 
      this/Person remainder)) && 
    (this/Person.spouse . univ) in (this/Jocelyn + this/Hilary + 
    this/Person remainder) && 
    (all P10_this: this/Jocelyn + this/Hilary + this/Person remainder | 
      (P10_this . this/Person.shaken) in (this/Jocelyn + this/Hilary + 
      this/Person remainder)) && 
    (this/Person.shaken . univ) in (this/Jocelyn + this/Hilary + 
    this/Person remainder) && 
    (all P10_p: this/Jocelyn + this/Hilary + this/Person remainder | 
      no ((P10_p + (P10_p . this/Person.spouse)) & (P10_p . this/Person.shaken))
     ) && 
    (all P10_p: this/Jocelyn + this/Hilary + this/Person remainder, P10_q: 
     this/Jocelyn + this/Hilary + this/Person remainder | 
      !(P10_p in (P10_q . this/Person.shaken)) || 
      P10_q in (P10_p . this/Person.shaken)) && 
    (all P10_p: this/Jocelyn + this/Hilary + this/Person remainder, P10_q: 
     this/Jocelyn + this/Hilary + this/Person remainder | 
      !!(P10_p = P10_q) || 
      ((!((P10_p . this/Person.spouse) = P10_q) || 
        (P10_q . this/Person.spouse) = P10_p) && 
       !((P10_p . this/Person.spouse) = (P10_q . this/Person.spouse)))) && 
    (all P10_p: this/Jocelyn + this/Hilary + this/Person remainder | 
      ((P10_p . this/Person.spouse) . this/Person.spouse) = P10_p && 
      !(P10_p = (P10_p . this/Person.spouse))) && 
    (all P10_p: (this/Jocelyn + this/Hilary + this/Person remainder) - 
     this/Jocelyn, P10_q: (this/Jocelyn + this/Hilary + this/Person remainder) - 
     this/Jocelyn | 
      !!(P10_p = P10_q) || 
      !(#(P10_p . this/Person.shaken) = #(P10_q . this/Person.shaken))) && 
    (this/Hilary . this/Person.spouse) = this/Jocelyn && 
    Int/min = Int/min && 
    Int/zero = Int/zero && 
    Int/max = Int/max && 
    Int/next = Int/next && 
    seq/Int = seq/Int && 
    String = String && 
    this/Jocelyn = this/Jocelyn && 
    this/Hilary = this/Hilary && 
    this/Person remainder = this/Person remainder && 
    this/Person.spouse = this/Person.spouse && 
    this/Person.shaken = this/Person.shaken
  ==================================================
*/
...
Formula[] formulas = ier.reduceIntExpressions( x12, x14, x23, x26, x31, x33, x41, x53, x74, x84, x101, x103, x104, x105, x106, x107, x108, x109, x110, x111, x112, x113);
