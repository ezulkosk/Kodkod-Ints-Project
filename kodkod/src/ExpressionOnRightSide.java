...
/* 
  ...
  ==================================================
    ...
    (all this: this/S | 
      Int[int[this . this/S.X] + int[this . this/S.Y]] = (this . this/S.Weight)) && 
    Int/min = Int/min && 
    Int/zero = Int/zero && 
    Int/max = Int/max && 
    Int/next = Int/next && 
  ...
  ==================================================
*/
public final class ExpressionOnRightSide {
...
Expression x47=x42.join(x8);
IntExpression x46=x47.sum();
Expression x49=x42.join(x9);
IntExpression x48=x49.sum();
IntExpression x45=x46.plus(x48);
Expression x44=x45.toExpression();
Expression x50=x42.join(x7);
Formula x43=x44.eq(x50);
...
Formula[] formulas = ier.reduceIntExpressions(x11,x19,x22,x29,x31,x38,x40,x51,x52,x53,x54,x55,x56,x57,x58,x59,x60);
