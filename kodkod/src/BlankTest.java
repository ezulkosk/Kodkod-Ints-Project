...
x7_upper.add(factory.tuple("unused0").product(factory.tuple("-4")));
x7_upper.add(factory.tuple("unused0").product(factory.tuple("-3")));
x7_upper.add(factory.tuple("unused0").product(factory.tuple("-2")));
x7_upper.add(factory.tuple("unused0").product(factory.tuple("-1")));
x7_upper.add(factory.tuple("unused0").product(factory.tuple("0")));
x7_upper.add(factory.tuple("unused0").product(factory.tuple("1")));
x7_upper.add(factory.tuple("unused0").product(factory.tuple("2")));
x7_upper.add(factory.tuple("unused0").product(factory.tuple("3")));
...
x8_upper.add(factory.tuple("unused0").product(factory.tuple("-4")));
x8_upper.add(factory.tuple("unused0").product(factory.tuple("-3")));
x8_upper.add(factory.tuple("unused0").product(factory.tuple("-2")));
x8_upper.add(factory.tuple("unused0").product(factory.tuple("-1")));
x8_upper.add(factory.tuple("unused0").product(factory.tuple("0")));
x8_upper.add(factory.tuple("unused0").product(factory.tuple("1")));
x8_upper.add(factory.tuple("unused0").product(factory.tuple("2")));
x8_upper.add(factory.tuple("unused0").product(factory.tuple("3")));
...
x9_upper.add(factory.tuple("unused0").product(factory.tuple("-4")));
x9_upper.add(factory.tuple("unused0").product(factory.tuple("-3")));
x9_upper.add(factory.tuple("unused0").product(factory.tuple("-2")));
x9_upper.add(factory.tuple("unused0").product(factory.tuple("-1")));
x9_upper.add(factory.tuple("unused0").product(factory.tuple("0")));
x9_upper.add(factory.tuple("unused0").product(factory.tuple("1")));
x9_upper.add(factory.tuple("unused0").product(factory.tuple("2")));
x9_upper.add(factory.tuple("unused0").product(factory.tuple("3")));
...
Expression x44=x42.join(x9);
Expression x48=x42.join(x7);
...
ier.solve(newFormula, bounds, factory, universe, 3); 
}}
