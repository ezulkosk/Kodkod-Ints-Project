...
/* 
  ...
  ==================================================
    ...
    (this/Test . this/Test.weight) = Int[3] && 
    Int/min = Int/min && 
    Int/zero = Int/zero && 
    Int/max = Int/max && 
    Int/next = Int/next && 
  ...
  ==================================================
*/
public final class ConstraintInPredicate {
...
Expression x140=x6.join(x11);
IntExpression x142=IntConstant.constant(3);
Expression x141=x142.toExpression();
Formula x139=x140.eq(x141);
Formula x143=x0.eq(x0);
Formula x144=x1.eq(x1);
Formula x145=x2.eq(x2);
Formula x146=x3.eq(x3);
Formula x147=x4.eq(x4);
Formula x148=x5.eq(x5);
Formula x149=x6.eq(x6);
Formula x150=x7.eq(x7);
Formula x151=x8.eq(x8);
Formula x152=x9.eq(x9);
Formula x153=x10.eq(x10);
Formula x154=x11.eq(x11);
Formula x155=x12.eq(x12);
Formula x156=x13.eq(x13);
Formula x157=x14.eq(x14);
