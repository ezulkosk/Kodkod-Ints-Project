...
/* 
  ...
  ==================================================
*/
public final class ApacheAlloy4 {
...
List<String> atomlist = Arrays.asList(
 ...
 "c63_total_performance$0", "concrete_int_bag%", "partial_c10_HostnameLookups%", "partial_c17_KeepAlive%", "partial_c23_EnableSendfile%", "partial_c29_FollowSymLinks%",
 "partial_c35_AccessLog%", "partial_c42_ExtendedStatus%", "partial_c49_InMemory%", "partial_c4_Base%", "partial_c57_Handle%", "performance_for_c10_HostnameLookups_of_minus26%",
 "performance_for_c17_KeepAlive_of_105%", "performance_for_c23_EnableSendfile_of_15%", "performance_for_c29_FollowSymLinks_of_0%", "performance_for_c35_AccessLog_of_minus15%", "performance_for_c42_ExtendedStatus_of_minus11%", "performance_for_c49_InMemory_of_26%",
 "performance_for_c4_Base_of_150%", "performance_for_c57_Handle_of_4%"
);
...
x7_upper.add(factory.tuple("partial_c10_HostnameLookups%"));
...
x9_upper.add(factory.tuple("partial_c23_EnableSendfile%"));
...
x11_upper.add(factory.tuple("partial_c35_AccessLog%"));
...
x15_upper.add(factory.tuple("performance_for_c10_HostnameLookups_of_minus26%"));
x15_upper.add(factory.tuple("performance_for_c17_KeepAlive_of_105%"));
x15_upper.add(factory.tuple("performance_for_c23_EnableSendfile_of_15%"));
x15_upper.add(factory.tuple("performance_for_c29_FollowSymLinks_of_0%"));
x15_upper.add(factory.tuple("performance_for_c35_AccessLog_of_minus15%"));
...
x19_upper.add(factory.tuple("partial_c10_HostnameLookups%").product(factory.tuple("performance_for_c10_HostnameLookups_of_minus26%")));
x19_upper.add(factory.tuple("partial_c17_KeepAlive%").product(factory.tuple("performance_for_c17_KeepAlive_of_105%")));
x19_upper.add(factory.tuple("partial_c23_EnableSendfile%").product(factory.tuple("performance_for_c23_EnableSendfile_of_15%")));
x19_upper.add(factory.tuple("partial_c29_FollowSymLinks%").product(factory.tuple("performance_for_c29_FollowSymLinks_of_0%")));
x19_upper.add(factory.tuple("partial_c35_AccessLog%").product(factory.tuple("performance_for_c35_AccessLog_of_minus15%")));
...
x20_upper.add(factory.tuple("performance_for_c10_HostnameLookups_of_minus26%").product(factory.tuple("-26")));
x20_upper.add(factory.tuple("performance_for_c17_KeepAlive_of_105%").product(factory.tuple("105")));
x20_upper.add(factory.tuple("performance_for_c23_EnableSendfile_of_15%").product(factory.tuple("15")));
x20_upper.add(factory.tuple("performance_for_c29_FollowSymLinks_of_0%").product(factory.tuple("0")));
x20_upper.add(factory.tuple("performance_for_c35_AccessLog_of_minus15%").product(factory.tuple("-15")));
...
x22_upper.add(factory.tuple("c101_simpleConfig$0").product(factory.tuple("partial_c10_HostnameLookups%")));
...
x24_upper.add(factory.tuple("c101_simpleConfig$0").product(factory.tuple("partial_c23_EnableSendfile%")));
...
x26_upper.add(factory.tuple("c101_simpleConfig$0").product(factory.tuple("partial_c35_AccessLog%")));
...
Formula[] formulas = ier.reduceIntExpressions(x34, x36, x39, x42, x45, x48, x51, x54, x57, x68, x79, x90, x101, x112, x123, x134, x150, x161, x169, x172, x180, x182, x187, x210, x217, x219, x226, x228, x235, x237, x244, x246, x253, x255, x262, x264, x271, x273, x280, x282, x289, x291, x298, x300, x351, x358, x360, x365, x370, x372, x373, x374, x375, x376, x377, x378, x379, x380, x381, x382, x383, x384, x385, x386, x387, x388, x389, x390, x391, x392, x393, x394, x395, x396, x397, x398, x399, x400, x401, x402, x403, x404);//x77, x78
