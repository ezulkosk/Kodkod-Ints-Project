...
pred Pred{
	all x: Test | x.weight = 3
	all x: Test2 | x.weight < 2
}
run Pred for exactly 1 Test, exactly 1 Test2, 4 Int
 */
/* 
  ==================================================
    kodkod formula: 
  ==================================================
    ...
    (all Pred_x: this/Test | 
      (Pred_x . this/Test.weight) = Int[3]) && 
    (all Pred_x: this/Test2 | 
      int[Pred_x . this/Test2.weight] < 2) && 
    Int/min = Int/min && 
    Int/zero = Int/zero && 
    Int/max = Int/max && 
    Int/next = Int/next && 
  ...
  ==================================================
*/
public final class ConstraintFor2InPredicate2 {
...
Variable x141=Variable.unary("Pred_x");
Decls x140=x141.oneOf(x6);
Expression x143=x141.join(x11);
IntExpression x145=IntConstant.constant(3);
Expression x144=x145.toExpression();
Formula x142=x143.eq(x144);
Formula x139=x142.forAll(x140);
Variable x148=Variable.unary("Pred_x");
Decls x147=x148.oneOf(x7);
Expression x151=x148.join(x15);
IntExpression x150=x151.sum();
IntExpression x152=IntConstant.constant(2);
Formula x149=x150.lt(x152);
Formula x146=x149.forAll(x147);
Formula x153=x0.eq(x0);
Formula x154=x1.eq(x1);
Formula x155=x2.eq(x2);
Formula x156=x3.eq(x3);
Formula x157=x4.eq(x4);
Formula x158=x5.eq(x5);
Formula x159=x6.eq(x6);
Formula x160=x7.eq(x7);
Formula x161=x8.eq(x8);
Formula x162=x9.eq(x9);
Formula x163=x10.eq(x10);
Formula x164=x11.eq(x11);
Formula x165=x12.eq(x12);
Formula x166=x13.eq(x13);
Formula x167=x14.eq(x14);
Formula x168=x15.eq(x15);
Formula x16=Formula.compose(FormulaOperator.AND, x17, x25, x28, x35, x37, x44, x46, x53, x55, x79, x86, x88, x95, x97, x104, x106, x113, x115, x139, x146, x153, x154, x155, x156, x157, x158, x159, x160, x161, x162, x163, x164, x165, x166, x167, x168);
...
Formula[] formulas = ier.reduceIntExpressions( x17, x25, x28, x35, x37, x44, x46, x53, x55, x79, x86, x88, x95, x97, x104, x106, x113, x115, x139, x146, x153, x154, x155, x156, x157, x158, x159, x160, x161, x162, x163, x164, x165, x166, x167, x168);//x77, x78
