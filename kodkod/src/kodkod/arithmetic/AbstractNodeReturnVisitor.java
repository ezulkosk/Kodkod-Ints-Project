...
public abstract class AbstractNodeReturnVisitor implements ReturnVisitor<Expression, Formula, Decls, IntExpression> {
	 ...
	 */
	protected AbstractNodeReturnVisitor(Set<Node> cached) { 
		this.cached = cached;
	 ...
	 */
	protected AbstractNodeReturnVisitor(Set<Node> cached, Map<Node,Node> cache) { 
		this.cached = cached;
		this.cache = cache;
	}
