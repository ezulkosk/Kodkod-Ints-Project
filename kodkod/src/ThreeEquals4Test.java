...
/* 
  ...
  ==================================================
*/
public final class ThreeEquals4Test {
...
x7_upper.add(factory.tuple("Test$3").product(factory.tuple("6")));
x7_upper.add(factory.tuple("Test$3").product(factory.tuple("7")));
x7_upper.add(factory.tuple("Test$4").product(factory.tuple("-8")));
x7_upper.add(factory.tuple("Test$4").product(factory.tuple("-7")));
x7_upper.add(factory.tuple("Test$4").product(factory.tuple("-6")));
x7_upper.add(factory.tuple("Test$4").product(factory.tuple("-5")));
x7_upper.add(factory.tuple("Test$4").product(factory.tuple("-4")));
x7_upper.add(factory.tuple("Test$4").product(factory.tuple("-3")));
x7_upper.add(factory.tuple("Test$4").product(factory.tuple("-2")));
x7_upper.add(factory.tuple("Test$4").product(factory.tuple("-1")));
x7_upper.add(factory.tuple("Test$4").product(factory.tuple("0")));
x7_upper.add(factory.tuple("Test$4").product(factory.tuple("1")));
x7_upper.add(factory.tuple("Test$4").product(factory.tuple("2")));
x7_upper.add(factory.tuple("Test$4").product(factory.tuple("3")));
x7_upper.add(factory.tuple("Test$4").product(factory.tuple("4")));
