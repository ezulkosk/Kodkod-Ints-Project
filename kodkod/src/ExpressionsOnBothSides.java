...
/* 
  ...
  ==================================================
    ...
    (all Pred_this: this/Test | 
      (int[Pred_this . this/Test.total] + 1) = (int[Pred_this . this/Test.field] - 
      int[Pred_this . this/Test.field2])) && 
    Int/min = Int/min && 
    Int/zero = Int/zero && 
    Int/max = Int/max && 
    Int/next = Int/next && 
  ...
  ==================================================
*/
public final class ExpressionsOnBothSides {
...
IntExpression x45=x46.sum();
IntExpression x47=IntConstant.constant(1);
IntExpression x44=x45.plus(x47);
Expression x50=x42.join(x7);
IntExpression x49=x50.sum();
Expression x52=x42.join(x8);
IntExpression x51=x52.sum();
IntExpression x48=x49.minus(x51);
Formula x43=x44.eq(x48);
...
Formula x62=x9.eq(x9);
Formula x10=Formula.compose(FormulaOperator.AND, x11, x19, x22, x29, x31, x38, x40, x53, x54, x55, x56, x57, x58, x59, x60, x61, x62);

IntExprReduction ier = new IntExprReduction();
Formula[] formulas = ier.reduceIntExpressions(x11, x19, x22, x29, x31, x38, x40, x53, x54, x55, x56, x57, x58, x59, x60, x61, x62);//x77, x78
